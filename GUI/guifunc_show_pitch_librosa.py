...
def runRead():
    ...
    while True:
        ...
        if(note_name in noteKeyDict and vol > volTreshold):
            ...
            noteToKey(note_name)
            prevNote = note_name
            return (noteKeyDict[note_name] + ' Volume: ' + "{:.3f}".format((vol)))
        ...
        if (note_name in noteMouse_X_PosDict and vol > volTreshold - 0.1):        
            ...
            return (str(noteMouse_X_PosDict[note_name]) + ' X, Volume: ' + "{:.3f}".format((vol)))
        ...
        if (note_name in noteMouse_Y_PosDict and vol > volTreshold - 0.1):        
            ...
            return (str(noteMouse_Y_PosDict[note_name]) + ' Y, Volume: ' + "{:.3f}".format((vol)))
        ...
        if (note_name in noteMouseClickDict and vol > volTreshold - 0.1):        
            ...
            return(str(noteMouseClickDict[note_name]) + ' Click, Volume: ' + "{:.3f}".format((vol)))
